...
class Cylinder implements SceneObject
{
    ...
    ArrayList<RayHit> intersect(Ray r)
    {
        ...
        float a = (dx * dx) + (dy * dy);
        float b = (2.0*ox*dx + 2.0*oy*dy);
        float c = ((ox * ox)+ (oy * oy) - (radius * radius));
        
        float sqrtVal = (float) Math.sqrt((b * b)- 4.0 * a * c);
        
        float t1 = ((-1.0 * b) + sqrtVal) / (2.0 * a);
        float t2 = ((-1.0 * b) - sqrtVal) / (2.0 * a);
        ...
        if(t1 > 0 && t2 > 0){
          ...
          rh1.t = t1;
          rh1.location = PVector.add(r.origin, (PVector.mult(r.direction, rh1.t)));
          rh1.normal = rh1.location.copy();
          rh1.normal.set(rh1.location.x,rh1.location.y,0).normalize();
          
          RayHit rh2 = new RayHit();
          rh2.t = t2;
          rh2.location = PVector.add(r.origin, (PVector.mult(r.direction, rh2.t)));
          rh2.normal = rh2.location.copy();
          rh2.normal.set(rh2.location.x,rh2.location.y,0).normalize();
          ...
          rh1.t = t1;
          rh1.location = PVector.add(r.origin, (PVector.mult(r.direction, rh1.t)));
          rh1.normal = new PVector(rh1.location.x,rh1.location.y,0).normalize();
          rh1.material = material;
          //calulate UV coords, supposed to be normalized idk tho
          rh1.u = 0.5 + (atan2(rh1.normal.x, rh1.normal.y) / (2 * PI));
          rh1.v = 0.5 - (asin(rh1.normal.z) / PI);
          ...
          rh2.t = t2;
          rh2.location = PVector.add(r.origin, (PVector.mult(r.direction, rh2.t)));
          rh2.normal = new PVector(rh2.location.x,rh2.location.y,0).normalize(); 
          rh2.material = material;
          //calulate UV coords, supposed to be normalized idk tho
          rh2.u = 0.5 + (atan2(rh2.normal.y, rh2.normal.x) / (2 * PI));
          rh2.v = 0.5 - (asin(rh2.normal.z) / PI);
...
class Cone implements SceneObject
{
    ...
    ArrayList<RayHit> intersect(Ray r)
    {
        ...
        float b = (2.0*ox*dx + 2.0*oy*dy - 2.0*oz*dz);
        ...
        if(t1 > 0 && t2 > 0){
          ...
          rh1.t = t1;
          rh1.location = PVector.add(r.origin, (PVector.mult(r.direction, rh1.t)));
          rh1.normal = new PVector(rh1.location.x,rh1.location.y,rh1.location.z).normalize();
          
          RayHit rh2 = new RayHit();
          rh2.t = t2;
          rh2.location = PVector.add(r.origin, (PVector.mult(r.direction, rh2.t)));
          rh2.normal = new PVector(rh2.location.x,rh2.location.y,rh2.location.z).normalize(); 
